...
namespace Oxide.Plugins
{
    ...
    class LustyMap : RustPlugin
    {
        ...
        void OnEntityKill(BaseNetworkable entity)
        {
            ...
            if (entityMarkers.ContainsKey((uint)entity.net.ID))
                entityMarkers.Remove((uint)entity.net.ID);
        ...
        private void AddTemporaryEntityMarker(BaseEntity entity)
        {
            ...
            entityMarkers.Add((uint)entity.net.ID, actEnt);
        }
